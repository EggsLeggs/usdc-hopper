...
- wagmi + viem for wallet connectivity (MetaMask + WalletConnect)
- Circle Bridge Kit + `@circle-fin/adapter-viem-v2`
- Arc routing client for quotes and fee estimates
- React Query for caching quotes / balances

### Features

- Detects the connected chain and pre-fills the “From” network
- Supports Ethereum Sepolia, Base Sepolia, Avalanche Fuji and Arc Testnet
- Arc quotes provide estimated receive amount, fee summary and ETA
...
| `NEXT_PUBLIC_RPC_AVALANCHE_FUJI` | (Optional) custom RPC for Avalanche Fuji |
...
| Avalanche Fuji | `43113` | `1` | `0x5425890298aed601595a70ab815c96711a31bc65` | [Avalanche Fuji](https://docs.avax.network/quickstart/fuji) |
...
- The Arc quote endpoint is configurable; when no API is available Hopper falls back to a deterministic fee estimate so the UI remains functional offline.
